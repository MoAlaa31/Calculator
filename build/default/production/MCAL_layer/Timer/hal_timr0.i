# 1 "MCAL_layer/Timer/hal_timr0.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_layer/Timer/hal_timr0.c" 2
...
# 1 "MCAL_layer/Timer/hal_timr0.h" 1
# 12 "MCAL_layer/Timer/hal_timr0.h"
...
# 13 "MCAL_layer/Timer/../std_libraries.h" 2
...
# 14 "MCAL_layer/Timer/hal_timr0.h" 2
...
# 33 "MCAL_layer/Timer/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 15 "MCAL_layer/Timer/hal_timr0.h" 2
...
# 15 "MCAL_layer/Timer/../Interrupt/mcal_interrupt_config.h"
# 1 "MCAL_layer/Timer/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 16 "MCAL_layer/Timer/../Interrupt/mcal_interrupt_config.h" 2
# 54 "MCAL_layer/Timer/../Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 14 "MCAL_layer/Timer/../Interrupt/mcal_internal_interrupt.h" 2
# 16 "MCAL_layer/Timer/hal_timr0.h" 2
# 47 "MCAL_layer/Timer/hal_timr0.h"
typedef enum{
...
typedef struct{
    ...
    timer_prescaler_select_t prescaler_value;
...
Std_ReturnType Timer0_Write_Value(const timer0_t *timer, uint16_t _value);
Std_ReturnType Timer0_Read_Value(const timer0_t *timer, uint16_t *_value);
# 8 "MCAL_layer/Timer/hal_timr0.c" 2
...
# 87 "MCAL_layer/Timer/hal_timr0.c"
static __attribute__((inline)) void Timer0_Prescaler_Config(const timer0_t *_timer){
