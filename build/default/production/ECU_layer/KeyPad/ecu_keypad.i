...
typedef struct{
    ...
    pin_config_t keypad_column_pins[6];
}keypad_t;
...
# 20 "ECU_layer/KeyPad/ecu_keypad.c"
...
Std_ReturnType keypad_initialize(const keypad_t *_keypad_obj){
    ...
    uint8 row_counter = 0, columns_counter = 0;
    if(((void*)0) == _keypad_obj){
        ret = (Std_ReturnType)0x00;
    }
    else{
        for(row_counter = 0; row_counter < 4; row_counter++){
            ret = gpio_pin_intialize(&(_keypad_obj->keypad_row_pins[row_counter]));
        }
...
Std_ReturnType keypad_get_value(const keypad_t *_keypad_obj, uint8 *value){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_row_counter = 0, l_columns_counter = 0, l_counter = 0;
    ...
    if((((void*)0) == _keypad_obj)||(((void*)0) == value)){
        ...
        for(l_row_counter = 0; l_row_counter < 4; l_row_counter++){
            ...
            gpio_pin_write_logic(&(_keypad_obj->keypad_row_pins[l_row_counter]), GPIO_HIGH);
